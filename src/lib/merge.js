...
export function buildStationData(station, metarSeries, fx, nowEpoch) {
  ...
  return {
    ...
    lat: station.lat, lon: station.lon, tz: station.tz, wuCode: station.wuCode ?? null, wcId: station.wcId ?? null,
    polyResolutionUrl: station.polyResolutionUrl ?? null,
    resolveNote: station.resolveNote ?? null,
