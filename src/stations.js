...
const RAW = [
  ...
  { city: 'Shanghai', stationLabel: 'Pudong Intl Airport', icao: 'ZSPD', lat: 31.143, lon: 121.805, tz: 'Asia/Shanghai', reportsTenths: false },
  { city: 'Paris', stationLabel: 'Paris-Le Bourget Airport', icao: 'LFPB', lat: 48.969, lon: 2.441, tz: 'Europe/Paris' },
  { city: 'Beijing', stationLabel: 'Capital Intl Airport', icao: 'ZBAA', lat: 40.080, lon: 116.585, tz: 'Asia/Shanghai', reportsTenths: false },
  ...
  { city: 'Lucknow', stationLabel: 'Chaudhary Charan Singh Intl', icao: 'VILK', lat: 26.761, lon: 80.889, tz: 'Asia/Kolkata', reportsTenths: false },
  { city: 'Milan', stationLabel: 'Malpensa Intl Airport', icao: 'LIMC', lat: 45.630, lon: 8.728, tz: 'Europe/Rome' },
  { city: 'Manila', stationLabel: 'Ninoy Aquino Intl', icao: 'RPLL', lat: 14.509, lon: 121.020, tz: 'Asia/Manila', reportsTenths: false },
  { city: 'Kuala Lumpur', stationLabel: 'KL Intl Airport', icao: 'WMKK', lat: 2.746, lon: 101.710, tz: 'Asia/Kuala_Lumpur', reportsTenths: false },
  { city: 'Jeddah', stationLabel: 'King Abdulaziz Intl', icao: 'OEJN', lat: 21.680, lon: 39.157, tz: 'Asia/Riyadh', reportsTenths: false },
  { city: 'Helsinki', stationLabel: 'Helsinki-Vantaa Airport', icao: 'EFHK', lat: 60.317, lon: 24.963, tz: 'Europe/Helsinki' },
  { city: 'Wuhan', stationLabel: 'Tianhe Intl Airport', icao: 'ZHHH', lat: 30.784, lon: 114.208, tz: 'Asia/Shanghai', reportsTenths: false },
  ...
  { city: 'Chengdu', stationLabel: 'Shuangliu Intl Airport', icao: 'ZUUU', lat: 30.578, lon: 103.947, tz: 'Asia/Shanghai', reportsTenths: false },
  { city: 'Chongqing', stationLabel: 'Jiangbei Intl Airport', icao: 'ZUCK', lat: 29.719, lon: 106.642, tz: 'Asia/Shanghai', reportsTenths: false },
  { city: 'Los Angeles', stationLabel: 'Los Angeles Intl', icao: 'KLAX', lat: 33.942, lon: -118.408, tz: 'America/Los_Angeles' },
  { city: 'Sao Paulo', stationLabel: 'Guarulhos Intl Airport', icao: 'SBGR', lat: -23.435, lon: -46.473, tz: 'America/Sao_Paulo', reportsTenths: false },
  { city: 'Busan', stationLabel: 'Gimhae Intl Airport', icao: 'RKPK', lat: 35.180, lon: 128.938, tz: 'Asia/Seoul' },
  { city: 'Istanbul', stationLabel: 'Istanbul Airport', icao: 'LTFM', lat: 41.262, lon: 28.742, tz: 'Europe/Istanbul',
    polyResolutionUrl: 'https://www.weather.gov/wrh/timeseries?site=LTFM' },
  ...
  { city: 'Moscow', stationLabel: 'Vnukovo Intl Airport', icao: 'UUWW', lat: 55.591, lon: 37.261, tz: 'Europe/Moscow',
    polyResolutionUrl: 'https://www.weather.gov/wrh/timeseries?site=UUWW' },
  { city: 'Tel Aviv', stationLabel: 'Ben Gurion Intl', icao: 'LLBG', lat: 32.011, lon: 34.887, tz: 'Asia/Jerusalem',
    polyResolutionUrl: 'https://www.weather.gov/wrh/timeseries?site=LLBG' },
  { city: 'Dallas', stationLabel: 'Dallas Love Field', icao: 'KDAL', lat: 32.847, lon: -96.852, tz: 'America/Chicago' },
  { city: 'Guangzhou', stationLabel: 'Baiyun Intl Airport', icao: 'ZGGG', lat: 23.392, lon: 113.299, tz: 'Asia/Shanghai', reportsTenths: false },
  { city: 'Panama City', stationLabel: 'Marcos A. Gelabert Intl', icao: 'MPMG', lat: 8.973, lon: -79.556, tz: 'America/Panama', reportsTenths: false },
  { city: 'Qingdao', stationLabel: 'Jiaodong Intl Airport', icao: 'ZSQD', lat: 36.366, lon: 120.086, tz: 'Asia/Shanghai', reportsTenths: false },
  { city: 'Cape Town', stationLabel: 'Cape Town Intl Airport', icao: 'FACT', lat: -33.969, lon: 18.597, tz: 'Africa/Johannesburg', reportsTenths: false },
